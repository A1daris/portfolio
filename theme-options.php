...
function theme_options_add_page() {
	add_theme_page( __( 'Skins options', 'sampletheme' ), __( 'Skins options', 'sampletheme' ), 'edit_theme_options', 'theme_options', 'theme_options_do_page' );
}
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Select skin color', 'sampletheme' ); ?></th>
					<td>
						...
						<label class="description" for="sample_theme_options[selectinput]"><?php _e( 'Choose color', 'sampletheme' ); ?></label>
					</td>
				</tr>
